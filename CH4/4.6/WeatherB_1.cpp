/*
File: WeatherB_1.cpp
Desc: To create a program per the problem Modify! 1
Author: spoonais
Date: 06/18/24 @12:13pm
*/
...
int main()
{
    ...
    //Create the logic
    for (t = start_t; t <= end_t; t += 0.167) //figure out how to create table for 10 minute increments
    {
