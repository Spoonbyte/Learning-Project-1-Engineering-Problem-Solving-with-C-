...
int main()
{
    ...
    short start_t(0), end_t(0), store_t(0);
    ...
    //Create the logic
    for (int count(0); count <= str_inc; ++count) //figure out how to create table for 10 minute increments
    {
        t = start_t + count*inc;
