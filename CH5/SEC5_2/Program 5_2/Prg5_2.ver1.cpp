/*
File: Prg5_2.ver1.cpp
Desc: This version is to simplify the "if-else" statement to make the program easier to understand. 
Wont need the if(i==1) part of the code. I think this is a little cleaner

Author: spoonais
Date: 07/25/24 @10:35am
*/
...
int main()
{
    ...
    //Store first value to use as comparison baseline
    wind_max = wind; //Can apparently write as "wind_max = wind_min = wind;"
    wind_min = wind;
    ...
    avg = sum / lines;  
    //Didnt need to make a variable "avg"...could just fout << sum/lines <<...SAVE STATIC MEMORY SINCE ITS A GLOBAL VARIABLE
    //LESSON: Dont make more variables than you need to!!!
